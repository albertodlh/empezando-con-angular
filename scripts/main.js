(function(){
  ...
  angular.module('prueba').controller('TestCtrl', [function(){
    this.avengers = avengers;
  }]);

  angular.module('prueba').directive('avengerReport', [function(){
    return {
      restrict: 'E',
  ...
  angular.module('prueba').directive('avengerDisplay', [function(){
    return {
      restrict: 'E',
